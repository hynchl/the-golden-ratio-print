...
function goldenRatio(t, x1, y1, x2, y2){
  b.println(count++/b.pow(2, T+1));
  drawDiagonal(t, x1, y1, x2, y2);
  // 재귀 호출 종료
  if(t==0){
    return;
  }
  ...
  function drawDivision(type, t, x1, y1, x2, y2){
    ...
    switch (type) {
      case 1:
        b.line(x1, y2-(x2-x1), x2, y2-(x2-x1));
        break;
      case 2:
